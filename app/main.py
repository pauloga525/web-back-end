...
app.include_router(documentos_router, prefix=PREFIX)

# Nota: las imágenes y documentos (PDF/Word) se sirven vía GridFS
# (/imagenes/gridfs/{id}, /documentos/gridfs/{id}), no desde disco.
